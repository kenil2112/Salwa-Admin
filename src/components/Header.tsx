  ...
  return (
    <div className="flex items-center lg:justify-end justify-between w-full">
      ...
      <div className="flex gap-5 items-center">
        ...
        {/* Language dropdown */}
        <div className="relative inline-block text-left flex-shrink-0" ref={languageMenuRef}>
          <button
            type="button"
          ...
          >
            ...
            <span className="hidden sm:inline text-sm">{currentLanguage.toUpperCase()}</span>
            ...
            <div
              ...
              <div className="py-1" role="none">
                <button
                  ...
                  style={{ 
                    color: currentLanguage === 'en' ? 'var(--accent-primary)' : 'var(--text-primary)',
                    backgroundColor: currentLanguage === 'en' ? 'var(--bg-tertiary)' : 'transparent'
                  }}
                  onMouseEnter={(e) => {
                ...
                <button
                  ...
                  style={{ 
                    color: currentLanguage === 'ar' ? 'var(--accent-primary)' : 'var(--text-primary)',
                    backgroundColor: currentLanguage === 'ar' ? 'var(--bg-tertiary)' : 'transparent'
                  }}
                  onMouseEnter={(e) => {
