...
const Offer71Details = () => {
  ...
  useEffect(() => {
    if (state?.mode === "view" || state?.mode === "edit") {
      ...
      setFormData({
        ...
        endDate: "2024-12-31",
        status: "Active",
        terms: "Valid for medical facilities and hospitals",
        conditions: "Minimum rental period of 90 days required"
      });
    }
  }, [state]);
  ...
  const handleBack = () => {
    navigate("/offer7-1/dashboard", { state });
  };
          ...
          <header className="flex flex-wrap items-start justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="max-w-xl text-sm font-textMedium text-gray-500">
                {state?.category?.title || "Category 7"} - {state?.service?.title || "Service 1"}
