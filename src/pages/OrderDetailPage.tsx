    ...
    useEffect(() => {
        ...
        const fetchOrderDetail = async () => {
            ...
            const mockOrderDetail: OrderDetail = {
                ...
                items: [
                    { orderNo: "#0003", orderTitle: "Uniform Cloths", uniformType: "Scrub", gender: "Male", size: "L", color: "White (#DDDDDD)" },
                    { orderNo: "#0023", orderTitle: "Uniform Cloths", uniformType: "Doctor Coat", gender: "Female", size: "S", color: "White (#DDDDDD)" },
                    { orderNo: "#0045", orderTitle: "Uniform Cloths", uniformType: "Scrub", gender: "Male", size: "XXL", color: "White (#DDDDDD)" },
                    { orderNo: "#0034", orderTitle: "Uniform Cloths", uniformType: "Doctor Coat", gender: "Female", size: "M", color: "White (#DDDDDD)" }
                ],
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-700">
                                    <strong>Contact Person Name :</strong> {orderDetail.contactPersonName}
                                </span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="w-2 h-2 bg-gray-900 rounded-full"></div>
                                <span className="text-gray-700">
                                    <strong>Contact Person Email :</strong> {orderDetail.contactPersonEmail}
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table className="w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                {orderDetail.items.map((item, index) => (
                                    <tr key={item.orderNo} className={index === 2 ? "bg-purple-50" : ""}>
