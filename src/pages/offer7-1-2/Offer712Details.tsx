...
const Offer712Details = () => {
  ...
  useEffect(() => {
    if (state?.mode === "view" || state?.mode === "edit") {
      ...
      setFormData({
        ...
        description: "Specialized medical equipment rental offer for subservice 7.1.2 with premium features",
        discount: "30",
        startDate: "2024-01-01",
        endDate: "2024-12-31",
        status: "Active",
        terms: "Valid for specialized medical facilities and clinics",
        conditions: "Minimum rental period of 90 days required for subservice 7.1.2"
      });
    }
  }, [state]);
  ...
  const handleBack = () => {
    navigate("/offer7-1-2/dashboard", { state });
  };
...
export default Offer712Details;
